...
const dataTable = {
  headerRow: ["Name", "User Name", "Email", "Mobile", "Created On","Actions","Status"],
  footerRow: ["Name", "Position", "Office", "Age", "Actions"],
  dataRows: [
    ["Kamal Kumar Kabra", "kamal.kabra", "kamal.kabra@gmail.com","9928282879","01/22/2020 06:18:19 AM"],
    ["Kamal Kumar Kabra", "kamal.kabra", "kamal.kabra@gmail.com","9928282879","01/22/2020 06:18:19 AM"],
    ["Kamal Kumar Kabra", "kamal.kabra", "kamal.kabra@gmail.com","9928282879","01/22/2020 06:18:19 AM"],
    ["Kamal Kumar Kabra", "kamal.kabra", "kamal.kabra@gmail.com","9928282879","01/22/2020 06:18:19 AM"]
...
const ContactUsMaster = {
  headerRow: ["Name", "Phoen Number", "Tracking Number", "Comments", "Request Status", "Call For","Created On","Actions"],
  footerRow: ["Name", "Phoen Number", "Tracking Number", "Comments", "Request Status", "Call For","Created On","Actions"],
  dataRows: [
    ["Joyce scheinman", "7023392773", "151034223","We have made all t","Cancelled","Sheryll J","01/23/2020 11:24:25AM" ],
    ["Joyce scheinman", "7023392773", "151034223","We have made all t","Cancelled","Sheryll J","01/23/2020 11:24:25AM" ],
    ["Joyce scheinman", "7023392773", "151034223","We have made all t","Cancelled","Sheryll J","01/23/2020 11:24:25AM" ],
    ["Joyce scheinman", "7023392773", "151034223","We have made all t","Cancelled","Sheryll J","01/23/2020 11:24:25AM" ]   
...
const CallBack = {
  headerRow: ["Name", "Phoen Number", "Time to Call", "Request Status", "Working on Request", "Created on","Actions"],
  footerRow: ["Name", "Phoen Number", "Time to Call", "Request Status", "Working on Request", "Created on","Actions"],
  dataRows: [
    ["Balamurugan Gnan", "3132891161", "05:00 PM to 07:00 PM (CST)","Cancelled","Sheryll J","01/23/2020 01:52:59"],
    ["Balamurugan Gnan", "3132891161", "05:00 PM to 07:00 PM (CST)","Cancelled","Sheryll J","01/23/2020 01:52:59"],
    ["Balamurugan Gnan", "3132891161", "05:00 PM to 07:00 PM (CST)","Cancelled","Sheryll J","01/23/2020 01:52:59"],
    ["Balamurugan Gnan", "3132891161", "05:00 PM to 07:00 PM (CST)","Cancelled","Sheryll J","01/23/2020 01:52:59"],
...
const FileaClaim = {
  headerRow: ["Tracki Ngnumber", "Claim Person", "Type of Claim", "Comments", "Desired Resolution", "Claim Date","Actions"],
  footerRow: ["Tracki Ngnumber", "Claim Person", "Type of Claim", "Comments", "Desired Resolution", "Claim Date","Actions"],
  dataRows: [
    ["151032143", "kamal", "Others", "1 Queen Mattress mis","Complete refund for e","01/29/2020 06:32:04 PM"],
    ["151032143", "kamal", "Others", "1 Queen Mattress mis","Complete refund for e","01/29/2020 06:32:04 PM"],
    ["151032143", "kamal", "Others", "1 Queen Mattress mis","Complete refund for e","01/29/2020 06:32:04 PM"],
    ["151032143", "kamal", "Others", "1 Queen Mattress mis","Complete refund for e","01/29/2020 06:32:04 PM"],
...
const OnlinePayment = {
  headerRow: ["Tracki Ngnumber", "Date", "Contact Name", "Contact Number", "Invoice Amount", "Payment Type","Payment Status","Actions"],
  footerRow: ["Tracki Ngnumber", "Date", "Contact Name", "Contact Number", "Invoice Amount", "Payment Type","Payment Status","Actions"],
  dataRows: [
    ["141010157", "01/29/2020 06:32:00 AM", "Suresh Kalimahanthi", "9182369907","1","Credit Card","Closed"],
    ["141010157", "01/29/2020 06:32:00 AM", "Suresh Kalimahanthi", "9182369907","1","Credit Card","Closed"],
    ["141010157", "01/29/2020 06:32:00 AM", "Suresh Kalimahanthi", "9182369907","1","Credit Card","Closed"],
    ["141010157", "01/29/2020 06:32:00 AM", "Suresh Kalimahanthi", "9182369907","1","Credit Card","Closed"],
