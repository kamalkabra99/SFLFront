        ...
        .then((res) => {
          if (res.success) {
            ...
            if (res.data.length > 0) {
              ...
              console.log("bbbb1", this.state.ratesBook);
              if (this.state.ratesBook === true) {
                document.getElementById("showTextBoxTO").style.display =
                  "block";
                document.getElementById("showAutocompleteTO").style.display =
                  "none";
              } else {
  ...
  ChangeFromUser = (event, value) => {
    ...
    if (value != null) {
      ...
      if (value.value == "Enter yourself") {
        ...
        console.log("bbbbbbbb", this.state.ratesBook);
        ...
        for (let index = 0; index < this.state.toContactList.length; index++) {
          ...
          if (this.state.toContactList[index].ContactName == value.value) {
            ...
            this.state.toAddressLine2 = this.state.toContactList[
              index
            ].AddressLine2;
            this.state.toAddressLine3 = this.state.toContactList[
              index
            ].AddressLine3;
            ...
            this.state.toCompanyName = this.state.toContactList[
              index
            ].CompanyName;
            this.state.toContactName = this.state.toContactList[
              index
            ].ContactName;
            break;
          }
    ...
    if (type === "tocompanyname") {
      if (!CommonConfig.isEmpty(event.target.value)) {
        if (event.target.value.length > 35) {
          ...
          this.setState({
            toCompanyName: event.target.value,
            toCompanyNameErr: true,
            toCompanyNameHelperText: "Please enter valid company name from A to Z",
          });
        } 
      ...
      if (CommonConfig.isEmpty(event.target.value)) {
        ...
        this.setState({
          toContactName: event.target.value,
          toContactNameErr: true,
          toContactNameHelperText: "Please enter valid contact name from A to Z",
        });
      } 
      else {
        this.setState({
      ...
      if (CommonConfig.isEmpty(event.target.value)) {
        ...
        this.setState({
          toAddressLine1: event.target.value,
          toAddressLine1Err: true,
          toAddressLine1HelperText: "Please enter valid AddressLine 1 from A to Z",
        });
      }
      else {
        this.setState({
      ...
      if (!CommonConfig.isEmpty(event.target.value)) {
        if (event.target.value.length > 35) {
          ...
          this.setState({
            toAddressLine2: event.target.value,
            toAddressLine2Err: true,
            toAddressLine2HelperText: "Please enter valid AddressLine 2 from A to Z",
          });
        }
        else {
          this.setState({
      ...
      if (!CommonConfig.isEmpty(event.target.value)) {
        if (event.target.value.length > 35) {
          ...
          this.setState({
            toAddressLine3: event.target.value,
            toAddressLine3Err: true,
            toAddressLine3HelperText: "Please enter valid AddressLine 3 from A to Z",
          });
        }
         else {
          this.setState({
