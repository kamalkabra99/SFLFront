...
class Scheduleshipment extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      ...
      console.log("kkkkkkk", nextProps.allStates.schedulepickup.skipstep2);
  ...
  dropdowndisplay() {
    ...
    document.getElementById("cd-dropdown-inner").style.display = "block";
    // ? "none"
    // : "block"
  }
  ...
  render() {
    ...
    console.log("check", fromContactOptions);
            ...
            <GridItem sm={4} md={4}>
              ...
              <div id="showAutocomplete" style={{ display: "none" }}>
                <Autocomplete
                  ...
                  onChange={(event, value) => this.ChangeFromUser(event, value)}
                  renderInput={(params) => (
                    <TextField
                      {...params}
                      margin="normal"
                ...
                >
                  ...
                  {this.state.IsShow ? (
                    <div
                      className="cd-dropdown-inner"
                      id="cd-dropdown-inner"
                      // style={{ display: "none" }}
                    >
                      <ul>
                        {fromContactOptions.map((item) => {
                          return (
                            <li
                              onClick={(event, value) =>
                ...
                {/* <ul>
                    <li>
                      <Icon className="cd-icon">person</Icon>Charbox, LLC
                    </li>
                    <li>
                      <Icon className="cd-icon">person</Icon>Charbox, LLC
                    </li>
                ...
                {/* <div className="cd-nofound">
                        <p>Can't find the name?</p>
                        <a href="#">ENTER THE NAME YOURSELF</a>
                      </div>
                    </div>
                  ) : null}
                </div> */}
            ...
            <GridItem sm={4} md={4}>
              {this.state.fromStateAutoComplete === false ? (
                ...
                <Autocomplete
                  ...
                  id="fromState"
                  autoSelect
                  // aria-readonly={this.state.disablefromState}
                  disabled={this.state.disablefromState}
                  getOptionLabel={(option) => option.label}
                  value={fromStateAutoCompleteVal}
                  onChange={(event, value) =>
