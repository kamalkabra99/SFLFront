...
//   offsetHours = gymOffset - localOffset;
// }
// else{
...
const startDateChange = (event) => {
  if(timeZone === 'America/Chicago'){
    console.log('date:',moment(event.start)
    .clone()
    .add(10, "hours")
    .toDate());
    // return moment(event.start).tz("America/Chicago").format("MM/DD/YYYY hh:mm A");
...
const endDateChange = (event) => {
  if(timeZone === 'America/Chicago'){
    console.log('date:',moment(event.end)
    // .clone()
    .add(10, "hours")
    .toDate());
    // return moment(event.end).tz("America/Chicago").format("MM/DD/YYYY hh:mm A");
