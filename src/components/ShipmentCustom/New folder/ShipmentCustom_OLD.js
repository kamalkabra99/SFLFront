...
class ShipmentCustom extends React.Component {
      ...
      if (type === "AllClear") {
        if (this.state.AllClear !== value.value) {
          ...
          if (
            ...
            else if (value.value === "Yes" && this.state.TotalCostInvoice != this.state.TotalCostReceived) {
              //kruti
              console.log(this.state.TotalCostInvoice + " ||| = "+ this.state.TotalCostReceived);
              this.setState({ IsChanged: false });
  ...
  handleDelete = () => {
    ...
    if(this.props.history.location.state.createDup == "1"){
      cogoToast.error("Please re-open the shipment to delete. It was duplicated created");
    }else{
  ...
  handleSave = (redirect) => {
    ...
    if (this.state.PackageType === "Package") {
      for (let index = 0; index < this.state.commercialList.length; index++) {
        ...
        if ((element > this.state.TotalPackages) && this.state.commercialList[index].Status == "Active") {
          count = 1
          break;
        }
      }
    ...
    if (count == 1) {
      console.log("In IF");
      cogoToast.error("Please enter valid package number for commercial invoice");
            ...
            <div className="shipment-content">
              ...
              <div className="shipment-pane" id="commercialinvoice">
                <Card>
                  ...
                  <CardBody className="shipment-cardbody">
                    {isComInvoiceVisible && this.state.PackageList.filter(
                      (x) => x.Status === "Active"
                    ).length > 0 ? (
                      <GridContainer className="MuiGrid-justify-xs-center">
                        <GridItem xs={12} sm={12} md={12}>
                        ...
                        <GridItem xs={12} sm={12} md={12}>
                          <div className="package-table">
                            <table>
                              ...
                              <tbody>
                                <tr>
                                  <td className="table-error" colSpan={4}>There is no package added. Please add atleast 1 package.</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
