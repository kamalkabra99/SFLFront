...
class FedExReport extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            file : '',
    ...
    viewPaymentIssued = () => {
        return this.state.ExcelJSONData.map((issued,index)=> { 
            issued.VendorName = 'FedEx';
            issued.PaidStatus = 'Yes';
            issued.InvoiceDate = moment(issued.InvoiceDate).toDate();
            issued.DatePaid = moment(issued.InvoiceDate).toDate();
        return (
            <tr key={index}>
                <td className="wd-150">
                    <CustomInput
                ...
                <td className="wd-150">
                    <CustomInput
                        inputProps={{
                            disabled : true,
                            value: moment(issued.DatePaid).format(CommonConfig.dateFormat.dateOnly),
                        }}
                    />
                </td>
                <td className="wd-150">
            ...
            <div>
                ...
                <Card>
                    <CardHeader className="btn-right-outer" color="primary" icon>
                        ...
                        <h4 className="margin-right-auto text-color-black">FedEx Invoice Upload</h4>
                    </CardHeader>
